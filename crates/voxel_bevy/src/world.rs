...
///
/// Uses type-erased sampler (`Box<dyn VolumeSampler>`) for ECS uniform component types.
/// Each entity with this component represents an independent voxel world.
///
/// # Example
///
/// ```ignore
...
pub fn cleanup_despawned_worlds(
    ...
    // This would require storing WorldId in VoxelChunk (which we do in the updated component)
